...
import { faPlusCircle, faEye, faSearch, faEdit } from '@fortawesome/free-solid-svg-icons';
...
export class ListProviderComponent implements OnInit {
  ...
  public searchRegistries(){
    this.enterpriseService.getByFilter$(this.searchForm.value,environment.enterprise_provider).pipe(
