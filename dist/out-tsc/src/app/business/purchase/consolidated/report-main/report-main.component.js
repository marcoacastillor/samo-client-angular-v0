...
var ReportMainComponent = /** @class */ (function () {
    ...
    */
    ...
    ReportMainComponent.prototype.loadData = function () {
        var _this = this;
        this.operationService.getConsolidateByDates$(moment(this.reportForm.value.from_date).format('YYYY-MM-DD'), moment(this.reportForm.value.to_date).format('YYYY-MM-DD'), environment.purchase).subscribe(function (data) { return _this.consolidates = data; });
    };
    ReportMainComponent.prototype.findOperationByTypePayment = function (paymentType) {
        var _this = this;
        this.operationService.getByPaymentTypeAndDatesAndType$(paymentType, moment(this.reportForm.value.from_date).format('YYYY-MM-DD'), moment(this.reportForm.value.to_date).format('YYYY-MM-DD'), environment.purchase).subscribe(function (operations) { return _this.lstOperations = operations; });
    };
